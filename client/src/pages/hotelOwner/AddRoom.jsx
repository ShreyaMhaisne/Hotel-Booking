...
const AddRoom = () => {
  ...
  return (
      <form>
        <Title align="left" font="outfit" title='Add Room' subtitle='Fill in the deatils
        carefully and accurate room details, pricing, and amenities,
            ...
            {Object.keys(inputs.amenities).map((amenity, index)=>(
                <div key={index}>
                    ...
                    onChange={()=>setInputs({...inputs,
                     ...
                     <label htmlFor={`amentities${index+1}`}>{amenity}</label>
                </div>
            ))}
        </div>
