...
const MyBooking = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 md:px-16 lg:px-24 xl:px-32'>

            <Title title='My Booking' subtitle='Easily manage your past, current, and upcoming hotel reservation in one place. 
      Plan your trips seamlesslywith just a few clicks' align='left' />
